...
export class Navbar extends Component {
    ...
    handleSubmit = (event) => {
        ...
        this.props.valueFromNavbar(this.state.inputValue)
    };
        ...
        return (
            <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top">
                <div className="container-fluid">
                    <Link className="navbar-brand wrapper" to="/"><img src='icon.png' style={{width:'25px',height:'25px',marginBottom:'5px', marginRight:'5px'}}></img>Weather Forecast</Link>
                    ...
                    <div className="collapse navbar-collapse " id="navbarSupportedContent">
                        ...
                        <form className="d-flex" onSubmit={this.handleSubmit}>
                            <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" value={this.state.value} onChange={this.handleChange} />
